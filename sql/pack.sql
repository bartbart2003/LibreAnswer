CREATE TABLE `pack_examplepack` (
  ...
  `multimediaType` text CHARACTER SET utf8 NOT NULL,
  `multimediaContent` text CHARACTER SET utf8 NOT NULL,
  ...
  `questionType` text CHARACTER SET utf8 NOT NULL,
  `questionExtra` text CHARACTER SET utf8 NOT NULL,
