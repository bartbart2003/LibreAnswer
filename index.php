...
<div id='homepageTextDiv' style='background-color: burlywood; font-size: 16px;'>v0.2</div><br>
...
<div style='text-align: center; margin: 5px; font-size: 13px;'><a href="http://libreanswer.bartbart.pl/creators<?php if ($langShort == 'pl') { echo '_pl'; } ?>" style='color: black'><?php echo gettext('learn how to create your own question pack') ?></a></div>
