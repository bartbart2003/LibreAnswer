...
<div style='text-align: center; font-size: 16px;'><?php echo gettext("A quiz making platform inspired by the 'Who Wants to Be a Millionaire?' TV show.") ?></div>
<div style='text-align: center; font-size: 16px;'><?php echo gettext('Version that this server is using is') ?> <span style='font-weight: bold'>v0.7.1</span>.</div>
<div style='text-align: center; font-size: 16px;'><?php echo gettext('Webpage:') ?> <a href='http://libreanswer.bartbart.eu'>LibreAnswer</a></div>
